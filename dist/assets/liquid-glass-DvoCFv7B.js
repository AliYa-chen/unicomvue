...
${i}}
`}function N(e){if(e<.5)return 1;let t=e*.57735+.5,n=2*Math.ceil(3*t)+1;return Math.min(33,Math.max(1,n))}function P(e){if(e<=1)return[{offset:0,weight:1}];let t=[],n=Math.floor(e/2),r=0;for(let i=0;i<e;i++){let e=i-n,a=Math.exp(-.5*e*e);t.push({offset:e,weight:a}),r+=a}if(r>0)for(let e of t)e.weight/=r;return t}function F(e,t){let n=P(e),r=t===`horizontal`?`vec2(1.0, 0.0)`:`vec2(0.0, 1.0)`,i=``;if(n.length===1)i=`    gl_FragColor = texture2D(uTexture, uv);
