<template>
  <div
    class="pointer-events-none fixed inset-0 z-[1] overflow-hidden opacity-0 transition-opacity duration-500 dark:opacity-60"
    aria-hidden="true"
    data-spotlight-background
  >
    <canvas ref="canvasRef" class="h-full w-full" data-spotlight-canvas></canvas>
  </div>
</template>
